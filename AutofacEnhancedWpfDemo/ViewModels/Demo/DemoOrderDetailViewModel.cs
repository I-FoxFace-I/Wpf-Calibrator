...
/// </summary>
public partial class DemoOrderDetailViewModel : BaseViewModel, IAsyncInitializable
{
    ...
    public DemoOrderDetailViewModel(
        ...
        ILogger<DemoOrderDetailViewModel> logger,
        DemoOrderDetailParams parameters) : base(logger)
    {
