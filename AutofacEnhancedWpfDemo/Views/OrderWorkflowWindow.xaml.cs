...
// ========== OrderWorkflowWindow ==========
public partial class OrderWorkflowWindow : ScopedWindow
{
    public OrderWorkflowWindow(
        ILifetimeScope parentScope,
        ILogger<OrderWorkflowWindow> logger)
        : base(parentScope, logger, "workflow")
    {
        InitializeComponent();
    ...
    {
        if (DataContext is OrderWorkflowViewModel vm)
        {
