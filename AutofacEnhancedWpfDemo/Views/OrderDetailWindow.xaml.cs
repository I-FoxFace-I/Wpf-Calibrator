...
public partial class OrderDetailWindow : ScopedWindow
{
    public OrderDetailWindow(
        ...
        ILogger<OrderDetailWindow> logger)
        : base(parentScope, logger, "order-detail")
    {
        InitializeComponent();
        Loaded += async (s, e) => await OnLoadedAsync();
    }

    public OrderDetailWindow(ILifetimeScope parentScope, ILogger logger, object? scopeTag = null) : base(parentScope, logger, scopeTag)
    {
    }
