...
///// Tracks windows and manages parent-child relationships
///// </summary>
...
//    // Track windows: (WindowId, ViewModelType) -> WindowInfo
...
//        _logger.LogInformation("[WINDOW_SERVICE] Opening window for {ViewModelType} (ID: {WindowId})",
...
//        _logger.LogInformation("[WINDOW_SERVICE] Opening window for {ViewModelType} with options (ID: {WindowId}, CorrelationId: {CorrelationId})",
...
//        _logger.LogInformation("[WINDOW_SERVICE] Opening child window for {ViewModelType} (ID: {WindowId}, Parent: {ParentId})",
...
//        _logger.LogInformation("[WINDOW_SERVICE] Opening child window for {ViewModelType} with options (ID: {WindowId}, Parent: {ParentId}, CorrelationId: {CorrelationId})",
...
//        _logger.LogInformation("[WINDOW_SERVICE] Closing window {ViewModelType} (ID: {WindowId})",
//            viewModelType.Name, windowId);
...
//        {
//            _logger.LogWarning("[WINDOW_SERVICE] Window {WindowId} has different ViewModel type: expected {Expected}, actual {Actual}",
...
//        where TViewModel : IViewModel, IDialogViewModel<TResult>
//    {
//        var viewModelType = typeof(TViewModel);
...
//        {
//            // Use reflection to set DialogResult property
...
//            {
//                _logger.LogDebug("[WINDOW_SERVICE] Closing child window {ChildId}", childId);
...
//        _logger.LogInformation("[WINDOW_SERVICE] Opening dialog for {ViewModelType} (ID: {WindowId})",
//            viewModelType.Name, windowId);
...
//        _logger.LogInformation("[WINDOW_SERVICE] Opening dialog for {ViewModelType} with options (ID: {WindowId}, CorrelationId: {CorrelationId})",
//            viewModelType.Name, windowId, options.CorrelationId);
...
//        // Set owner to active window if available
...
//        {
//            _logger.LogDebug("[WINDOW_SERVICE] Initializing {ViewModelType}", viewModelType.Name);
//            _ = initializable.InitializeAsync();
//        }

//        // Show as modal dialog
//        _logger.LogInformation("[WINDOW_SERVICE] Showing modal dialog (ID: {WindowId})", windowId);
//        window.ShowDialog();
...
//        _logger.LogInformation("[WINDOW_SERVICE] Window opened successfully (ID: {WindowId}, Type: {ViewModelType})",
...
//    {
//        _logger.LogInformation("[WINDOW_SERVICE] Window closed (ID: {WindowId}, Type: {ViewModelType})",
//            windowId, viewModelType.Name);
...
//    {
//        _logger.LogInformation("[WINDOW_SERVICE] Dialog closed (ID: {WindowId}, Type: {ViewModelType})",
//            windowId, viewModelType.Name);

//        // Remove from tracking
//        _openWindows.Remove(windowId);

//        // Complete TaskCompletionSource if dialog was closed without explicit result
//        if (_dialogCompletionSources.TryGetValue(windowId, out var tcs))
//        {
//            // Check if ViewModel has result
...
//            else
//            {
//                tcs.TrySetResult(null); // Dialog cancelled
//            }
